    ...
    public partial class Migrations : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, null, 1, new DateTime(2024, 11, 23, 12, 48, 21, 201, DateTimeKind.Local).AddTicks(1180), 1, "Uåpnet", 1 },
                    { 2, null, 2, new DateTime(2024, 11, 23, 12, 48, 21, 201, DateTimeKind.Local).AddTicks(1210), 2, "Under behandling", 1 },
                    ...
                    { 4, null, 4, new DateTime(2024, 11, 23, 12, 48, 21, 201, DateTimeKind.Local).AddTicks(1210), 4, "Uåpnet", 1 },
                    { 5, null, 5, new DateTime(2024, 11, 23, 12, 48, 21, 201, DateTimeKind.Local).AddTicks(1210), 5, "Under behandling", 1 },
                    ...
                    { 7, null, 7, new DateTime(2024, 11, 23, 12, 48, 21, 201, DateTimeKind.Local).AddTicks(1210), 7, "Uåpnet", 1 },
                    { 8, null, 8, new DateTime(2024, 11, 23, 12, 48, 21, 201, DateTimeKind.Local).AddTicks(1220), 8, "Under behandling", 1 },
                    ...
                    { 10, null, 10, new DateTime(2024, 11, 23, 12, 48, 21, 201, DateTimeKind.Local).AddTicks(1220), 10, "Uåpnet", 1 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Hei Ola, vi trenger mer informasjon om veiskaden du rapporterte.", 1, 1, 12, "sendt", new DateTime(2024, 11, 23, 12, 48, 21, 201, DateTimeKind.Local).AddTicks(1270) },
                    { 2, "Hei, her er de detaljerte opplysningene om veiskaden.", 12, 1, 1, "sendt", new DateTime(2024, 11, 23, 12, 48, 21, 201, DateTimeKind.Local).AddTicks(1280) },
                    { 3, "Kari, kan du bekrefte oversv�mmelsen i omr�det du rapporterte?", 2, 2, 12, "sendt", new DateTime(2024, 11, 23, 12, 48, 21, 201, DateTimeKind.Local).AddTicks(1280) },
                    { 4, "Bekreftet, omr�det er fortsatt oversv�mt.", 12, 2, 2, "sendt", new DateTime(2024, 11, 23, 12, 48, 21, 201, DateTimeKind.Local).AddTicks(1280) },
                    { 5, "Per, vi trenger oppdateringer om fjellskredet.", 3, 3, 12, "sendt", new DateTime(2024, 11, 23, 12, 48, 21, 201, DateTimeKind.Local).AddTicks(1280) },
                    { 6, "Fjellskredet er n� under overv�king.", 12, 3, 3, "sendt", new DateTime(2024, 11, 23, 12, 48, 21, 201, DateTimeKind.Local).AddTicks(1280) },
                    { 7, "Anne, kan du sende bilder av den skadede stien?", 4, 4, 12, "sendt", new DateTime(2024, 11, 22, 12, 48, 21, 201, DateTimeKind.Local).AddTicks(1280) },
                    { 8, "Selvf�lgelig, her er bildene.", 12, 4, 4, "sendt", new DateTime(2024, 11, 23, 12, 48, 21, 201, DateTimeKind.Local).AddTicks(1290) },
                    { 9, "Nina, har du innsikt i b�tvrakene?", 5, 5, 12, "sendt", new DateTime(2024, 11, 23, 12, 48, 21, 201, DateTimeKind.Local).AddTicks(1290) },
                    { 10, "Ja, vi trenger assistanse for rydding.", 12, 5, 5, "sendt", new DateTime(2024, 11, 23, 12, 48, 21, 201, DateTimeKind.Local).AddTicks(1290) },
                    { 11, "Erik, vi har behov for rapporter om trafikkulykken.", 6, 6, 12, "sendt", new DateTime(2024, 11, 23, 12, 48, 21, 201, DateTimeKind.Local).AddTicks(1290) },
                    { 12, "Rapportene er under arbeid og vil bli levert snart.", 12, 6, 6, "sendt", new DateTime(2024, 11, 23, 12, 48, 21, 201, DateTimeKind.Local).AddTicks(1290) },
                    { 13, "Lise, sn�rasen er kritisk, kan du igangsette tiltak?", 7, 7, 12, "sendt", new DateTime(2024, 11, 23, 12, 48, 21, 201, DateTimeKind.Local).AddTicks(1290) },
                    { 14, "Tiltak er iverksatt for � h�ndtere sn�rasen.", 12, 7, 7, "sendt", new DateTime(2024, 11, 23, 12, 48, 21, 201, DateTimeKind.Local).AddTicks(1290) },
                    { 15, "Hans, vi trenger mer informasjon om sykkelsti-skaden.", 8, 8, 12, "sendt", new DateTime(2024, 11, 23, 12, 48, 21, 201, DateTimeKind.Local).AddTicks(1290) },
                    { 16, "Her er de n�dvendige detaljene.", 12, 8, 8, "sendt", new DateTime(2024, 11, 23, 12, 48, 21, 201, DateTimeKind.Local).AddTicks(1300) },
                    { 17, "Mona, kan du overv�ke fiskefeltet?", 9, 9, 12, "sendt", new DateTime(2024, 11, 23, 12, 48, 21, 201, DateTimeKind.Local).AddTicks(1300) },
                    { 18, "Fiskefeltet overv�kes kontinuerlig.", 12, 9, 9, "sendt", new DateTime(2024, 11, 23, 12, 48, 21, 201, DateTimeKind.Local).AddTicks(1300) },
                    { 19, "Tom, vi trenger data om fiskeriforvaltningen.", 10, 10, 12, "sendt", new DateTime(2024, 11, 23, 12, 48, 21, 201, DateTimeKind.Local).AddTicks(1300) },
                    { 20, "Dataene er samlet og kan sendes.", 12, 10, 10, "sendt", new DateTime(2024, 11, 23, 12, 48, 21, 201, DateTimeKind.Local).AddTicks(1300) }
                });
