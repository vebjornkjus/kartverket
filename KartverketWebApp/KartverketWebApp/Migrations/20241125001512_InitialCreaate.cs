    ...
    public partial class InitialCreaate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, null, 1, new DateTime(2024, 11, 25, 1, 15, 11, 855, DateTimeKind.Local).AddTicks(7948), 1, "Uåpnet", 1 },
                    { 2, null, 2, new DateTime(2024, 11, 25, 1, 15, 11, 855, DateTimeKind.Local).AddTicks(7993), 2, "Under behandling", 1 },
                    ...
                    { 4, null, 4, new DateTime(2024, 11, 25, 1, 15, 11, 855, DateTimeKind.Local).AddTicks(7998), 4, "Uåpnet", 8 },
                    { 5, null, 5, new DateTime(2024, 11, 25, 1, 15, 11, 855, DateTimeKind.Local).AddTicks(7999), 5, "Under behandling", 1 },
                    ...
                    { 7, null, 7, new DateTime(2024, 11, 25, 1, 15, 11, 855, DateTimeKind.Local).AddTicks(8001), 7, "Uåpnet", 8 },
                    { 8, null, 8, new DateTime(2024, 11, 25, 1, 15, 11, 855, DateTimeKind.Local).AddTicks(8003), 8, "Under behandling", 8 },
                    ...
                    { 10, null, 10, new DateTime(2024, 11, 25, 1, 15, 11, 855, DateTimeKind.Local).AddTicks(8005), 10, "Uåpnet", 8 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Hei Ola, vi trenger mer informasjon om veiskaden du rapporterte.", 1, 1, 12, "sendt", new DateTime(2024, 11, 25, 1, 15, 11, 855, DateTimeKind.Local).AddTicks(8109) },
                    { 2, "Hei, her er de detaljerte opplysningene om veiskaden.", 12, 1, 1, "sendt", new DateTime(2024, 11, 25, 1, 15, 11, 855, DateTimeKind.Local).AddTicks(8112) },
                    { 3, "Kari, kan du bekrefte oversv�mmelsen i omr�det du rapporterte?", 2, 2, 12, "sendt", new DateTime(2024, 11, 25, 1, 15, 11, 855, DateTimeKind.Local).AddTicks(8114) },
                    { 4, "Bekreftet, omr�det er fortsatt oversv�mt.", 12, 2, 2, "sendt", new DateTime(2024, 11, 25, 1, 15, 11, 855, DateTimeKind.Local).AddTicks(8116) },
                    { 5, "Per, vi trenger oppdateringer om fjellskredet.", 3, 3, 12, "sendt", new DateTime(2024, 11, 25, 1, 15, 11, 855, DateTimeKind.Local).AddTicks(8117) },
                    { 6, "Fjellskredet er n� under overv�king.", 12, 3, 3, "sendt", new DateTime(2024, 11, 25, 1, 15, 11, 855, DateTimeKind.Local).AddTicks(8119) },
                    { 7, "Anne, kan du sende bilder av den skadede stien?", 4, 4, 20, "sendt", new DateTime(2024, 11, 24, 1, 15, 11, 855, DateTimeKind.Local).AddTicks(8121) },
                    { 8, "Selvf�lgelig, her er bildene.", 20, 4, 4, "sendt", new DateTime(2024, 11, 25, 1, 15, 11, 855, DateTimeKind.Local).AddTicks(8124) },
                    { 9, "Nina, har du innsikt i b�tvrakene?", 5, 5, 12, "sendt", new DateTime(2024, 11, 25, 1, 15, 11, 855, DateTimeKind.Local).AddTicks(8126) },
                    { 10, "Ja, vi trenger assistanse for rydding.", 12, 5, 5, "sendt", new DateTime(2024, 11, 25, 1, 15, 11, 855, DateTimeKind.Local).AddTicks(8127) },
                    { 11, "Erik, vi har behov for rapporter om trafikkulykken.", 6, 6, 12, "sendt", new DateTime(2024, 11, 25, 1, 15, 11, 855, DateTimeKind.Local).AddTicks(8129) },
                    { 12, "Rapportene er under arbeid og vil bli levert snart.", 12, 6, 6, "sendt", new DateTime(2024, 11, 25, 1, 15, 11, 855, DateTimeKind.Local).AddTicks(8131) },
                    { 13, "Lise, sn�rasen er kritisk, kan du igangsette tiltak?", 7, 7, 12, "sendt", new DateTime(2024, 11, 25, 1, 15, 11, 855, DateTimeKind.Local).AddTicks(8133) },
                    { 14, "Tiltak er iverksatt for � h�ndtere sn�rasen.", 12, 7, 7, "sendt", new DateTime(2024, 11, 25, 1, 15, 11, 855, DateTimeKind.Local).AddTicks(8135) },
                    { 15, "Hans, vi trenger mer informasjon om sykkelsti-skaden.", 8, 8, 12, "sendt", new DateTime(2024, 11, 25, 1, 15, 11, 855, DateTimeKind.Local).AddTicks(8136) },
                    { 16, "Her er de n�dvendige detaljene.", 12, 8, 8, "sendt", new DateTime(2024, 11, 25, 1, 15, 11, 855, DateTimeKind.Local).AddTicks(8138) },
                    { 17, "Mona, kan du overv�ke fiskefeltet?", 9, 9, 12, "sendt", new DateTime(2024, 11, 25, 1, 15, 11, 855, DateTimeKind.Local).AddTicks(8140) },
                    { 18, "Fiskefeltet overv�kes kontinuerlig.", 12, 9, 9, "sendt", new DateTime(2024, 11, 25, 1, 15, 11, 855, DateTimeKind.Local).AddTicks(8142) },
                    { 19, "Tom, vi trenger data om fiskeriforvaltningen.", 10, 10, 12, "sendt", new DateTime(2024, 11, 25, 1, 15, 11, 855, DateTimeKind.Local).AddTicks(8144) },
                    { 20, "Dataene er samlet og kan sendes.", 12, 10, 10, "sendt", new DateTime(2024, 11, 25, 1, 15, 11, 855, DateTimeKind.Local).AddTicks(8145) }
                });
